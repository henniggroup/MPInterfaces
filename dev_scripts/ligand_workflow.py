...
def get_calibration_task(structure, phase="CalibrateBulk", \
                         slab_interface_params={'hkl': [1, 0, 0],
                                                'ligand': None}, \
...
def get_workflow(fireworks=None, name=None):
    ...
    return Workflow(fireworks,
                    links_dict={fireworks[i - 1].fw_id: fireworks[i].fw_id for \
...
if __name__ == '__main__':
    ...
    bulk_fireworks.append(
        Firework([bulk_firetasks[0]], name='bulk_convergence'))
    ...
    slab = Interface(bulk, hkl=[1, 0, 0], min_thick=10, min_vac=10,
                     ...
                     solvent="amine", start_from_slab=False,
                     validate_proximity=False,
    ...
    measurement_firetasks.append(get_measurement_task(structure=ligand,
                                                      sol_add={'EB_K': [1, 4.6,
                                                                        47.6]}))
    measurement_fireworks.append(
        Firework(measurement_firetasks, name='solvation'))
